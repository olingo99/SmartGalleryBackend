...
class PhotoListAPITests(HelperTestCase):
    def test_create_photo(self):
        ...
        self.assertEqual(Photo.objects.get().Location, 'testlocation')
...
class PhotoDetalAPITests(HelperTestCase):
    def test_get_photo(self):
        ...
        self.assertEqual(response.data['Location'], 'testlocation')
    ...
    def test_update_photo(self):
        ...
        self.assertEqual(Photo.objects.get().Location, 'testlocation1')
        self.assertEqual(Photo.objects.get().User, self.user)
